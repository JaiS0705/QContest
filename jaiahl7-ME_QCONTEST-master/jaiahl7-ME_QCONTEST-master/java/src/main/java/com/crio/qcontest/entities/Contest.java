...
import com.crio.qcontest.exception.InvalidContestException;
...
public class Contest {
    ...
    private void validateQuestions(List<Question> questions, Level level) throws InvalidContestException {
        // for(int i=0;i<questions.size();i++)
        // {
        //     if(questions.get(i).getLevel()!=level)
        //     {
        //         throw new LevelException("Level of question different from contest level!");
        //     }
        // }
